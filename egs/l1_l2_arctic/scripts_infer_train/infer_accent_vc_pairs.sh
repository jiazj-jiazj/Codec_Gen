...
--semantic-sys-dir /home/v-zhijunjia/data/accent_icml/100pairs_accent_classifier/source_native_wavs \
--audio-prompts-dir /home/v-zhijunjia/data/accent_icml/100pairs_accent_classifier/prompt_native_wavs_7s_larger \
--prompt-pre-cut True \
--prompt-cut-seconds 7 \
--input-semantic True \
...
--mode 0 \
--mode-stage2 0 \
--outputdir-name converted_test_can_del/length_test_7s_prompt_native_vc_icml_accent_pass_top_${top_k}_topp_${top_p}_${basestr} > /home/v-zhijunjia/CodecGen/egs/l1_l2_arctic/log/length_test_7s_prompt_native_vc_icml_accent${basestr}.txt 2>&1 &
