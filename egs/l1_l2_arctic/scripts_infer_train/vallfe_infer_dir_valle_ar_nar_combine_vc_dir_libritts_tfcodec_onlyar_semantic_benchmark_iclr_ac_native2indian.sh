...
for epoch in $(seq 17 1 17); do  
    ...
    --semantic-sys-dir /home/v-zhijunjia/zhijundata_small_v2/data_local/accent_wer/val_ac_models_native2indian/native_accent_test_arctics_50cases \
    --input-semantic True \
    --only-autoregressive True \
    --prefix-mode 1 \
    --checkpoint1 /home/v-zhijunjia/zhijundata_small_v2/data_local/valle-tensorboard-models/pretrain_finetune/VALLFE_hubert_sem/native2all_indian_txt_infilling_all_cases_lr_0_001_tune_decoder/epoch-${epoch}.pt \
    ...
    --is-pretrain True \
    --pret-mode 0 \
    --outputdir-name converted_can_del/vallfe_native2indian_tune_all_all_cases_lr_0_001_${top_k}_epoch_${epoch}_${basestr}
done    
