...
for epoch in $(seq 2 1 3); do  
    ...
    --prefix-mode 1 \
    --checkpoint1 /home/v-zhijunjia/zhijundata_small_v2/data_local/valle-tensorboard-models/pretrain_finetune/VALLE_hubert_sem/native2all_indian_txt_infilling_all_cases_lr_0_001/epoch-${epoch}.pt \
    ...
    --is-pretrain True \
    --pret-mode 0 \
    --outputdir-name converted_can_del/native2all_indian_txt_infilling_all_cases_lr_0_001_${top_k}_epoch_${epoch}_${basestr}
done    
