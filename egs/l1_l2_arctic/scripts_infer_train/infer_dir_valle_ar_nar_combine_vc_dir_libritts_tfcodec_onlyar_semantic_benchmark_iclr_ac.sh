...
# top_k_stage2=10
# add_prenet="False"
# # for epoch in $(seq 15 1 15); do  
# for top_k in $(seq 1 1 3); do
#     python egs/libritts/bin/combine_ar_nar_vc_dir_onlyar.py \
...
#     --semantic-tokens /home/v-zhijunjia/zhijundata_small_v2/data_local/data/lhotse_data_vc_target_semantic_native/tokenized/unique_semantic_tokens.k2symbols \
...
#     --prefix-mode 1 \
#     --checkpoint1 /home/v-zhijunjia/zhijundata_small_v2/data_local/valle-tensorboard-models/pretrain_finetune/VALLE_NAR_hubert_sem/mask_0_5/indian2native_lr_0_002/epoch-20.pt \
...
#     --is-pretrain True \
#     --pret-mode 0 \
#     --outputdir-name converted_can_del/valle_nar_ac_${top_k}_epoch_${epoch}_topk_${top_k}_${basestr}
# done
# # done    
...
top_k_stage2=10
add_prenet="False"
# for top_k_stage2 in $(seq 10 1 10); do
for top_k_stage2 in $(seq 10 1 10); do
    ...
    --nums ${num_runs} \
    --nums-stage2 ${num_runs_stage2} \
    --semantic-tokens /home/v-zhijunjia/zhijundata_small_v3/data_local/data/lhotse_data_vc_target_semantic_native/tokenized/unique_semantic_tokens.k2symbols \
    --semantic-sys-dir /home/v-zhijunjia/data/icml_more_accent/Korean_/source_accent_cases \
    --input-semantic True \
    --only-autoregressive True \
    --prompt-pre-cut True \
    --prefix-mode 1 \
    --checkpoint1 /home/v-zhijunjia/zhijundata_small_v3/data_local/valle-tensorboard-models/pretrain_finetune/VALLE_hubert_sem/indiantts_l1l2_indain2native_4speakers/epoch-10.pt \
    --checkpoint2 /home/v-zhijunjia/data/valle-tensorboard-models/vc/only_ar/epoch-40.pt \
    --top-k ${top_k} \
    --prepend-bos False \
    --prepend-bos-stage2 False \
    ...
    --is-pretrain True \
    --pret-mode 0 \
    --outputdir-name converted_can_del/dns_vctk_20_cases_IndicTTS_indian_native2all_native_txt_infilling_all_cases_tgt_4_speakers_lr_0_001_topk_${top_k}_epoch_${epoch}_top_k_stage2_${top_k_stage2}_${basestr} > l1_l2_ac_proposed_topktopk_${top_k}_epoch_${epoch}_top_k_stage2_${top_k_stage2}_${basestr}.txt 2>&1 &
done    
...
#     --only-autoregressive True \
#     --prefix-mode 1 \
#     --checkpoint1 /home/v-zhijunjia/zhijundata_small_v2/data_local/valle-tensorboard-models/pretrain_finetune/VALLE_hubert_sem/indiantts_l1l2_indain2native_4speakers/epoch-${epoch}.pt \
#     --checkpoint2 /home/v-zhijunjia/data/valle-tensorboard-models/vc/only_ar/epoch-40.pt \
#     --top-k ${top_k} \
#     --prepend-bos False \
#     --prepend-bos-stage2 False \
...
#     --is-pretrain True \
#     --pret-mode 0 \
#     --outputdir-name converted_can_del/IndicTTS_indian_native2all_native_txt_infilling_all_cases_tgt_4_speakers_lr_0_001_topk_${top_k}_epoch_${epoch}_${basestr}
# done    
# for epoch in {3..8}; do
