        ...
        for root, dirs, files in os.walk(input_dir):  
            ...
            for file_name in files:  
                ...
                if file_path.endswith(".wav") or file_path.endswith(".flac"):  
                    ...
                    # 使用模型进行预测  
                    result = model.transcribe('/home/v-zhijunjia/zhijundata_small_v2/data_local/accent_wer/val_ac_models/IndicTTS_indian_native2all_native_txt_infilling_all_cases/prompt1_ASI_arctic_b0505_sys2_ASI_arctic_b0505_model3_ar_epoch-10pt_nar_epoch-40pt_2024_01_30_04_53_26_0_0.wav')
