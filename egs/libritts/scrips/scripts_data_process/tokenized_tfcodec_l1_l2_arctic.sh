...
audio_output_dir="/mnt/zhijun/Accents/combine_L1_L2/tokenized_tfcodec/${out_dir_name}"
CUDA_VISIBLE_DEVICES=0 python3 egs/libritts/bin/tokenizer.py --dataset-parts "${dataset_parts}" \
    --audio-extractor Tfcodec \
    --prefix "l1_l2_arctic" \
    --batch-duration 200 \
    --src-dir /mnt/zhijun/Accents/combine_L1_L2/manifests \
    --wav-path /mnt/zhijun/Accents/combine_L1_L2/train_india_split/ \
