...
dataset_parts="-p dev -p test"  # debug
text_extractor="pypinyin_initials_finals"



out_dir_name="tokenized_16k_layer9"
audio_output_dir="/mnt/users/jiazhijun/data/AISHELL_lhotse_data/data/${out_dir_name}"
nohup env CUDA_VISIBLE_DEVICES=2 python3 -u egs/libritts/bin/tokenizer.py --dataset-parts "${dataset_parts}" \
    ...
    --prefix "aishell" \
    --batch-duration 400 \
    --src-dir /mnt/users/jiazhijun/data/AISHELL_lhotse_data/data/manifests \
    --acoustic-sample 16000 \
    --input-language 1 \
    --semantic-layer 9 \
    --output-dir ${audio_output_dir} > egs/libritts/log/aishell1_${out_dir_name}_${basestr}.txt 2>&1 &
...
#     --input-language 1 \
#     --semantic-layer 9 \
#     --output-dir /mnt/users/jiazhijun/data/AISHELL_lhotse_data/data/tokenized_16k_layer9
