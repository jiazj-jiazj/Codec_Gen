...
top_k_stage2=10
add_prenet="False"  
CUDA_VISIBLE_DEVICES=0 nohup python egs/libritts/bin/generate_semantic_through_pretrain.py --model-name valle --norm-first true --add-prenet ${add_prenet} \
...
--semantic-sys-dir /home/v-zhijunjia/data/test_accent_baseline_paper/source_another_spk \
--input-semantic True \
--only-autoregressive True \
--prefix-mode 1 \
--checkpoint1 /home/v-zhijunjia/data/valle-tensorboard-models/pretrain/mode_5_mask_0_15/epoch-53.pt \
...
--is-pretrain True \
--pret-mode 0 \
--outputdir-name "ac_source_another_spk_pret_mode_2_tune_allac_epoch_3" \
> egs/libritts/log/purify_cuts_train_split_0.jsonl_${basestr}.txt 2>&1 &
