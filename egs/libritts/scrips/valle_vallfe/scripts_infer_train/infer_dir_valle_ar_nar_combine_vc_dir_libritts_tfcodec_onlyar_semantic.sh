...
--semantic-sys-dir /home/v-zhijunjia/data/test_vc/test_accent_baseline_paper/converted_semantic_vc/test_improve_semantic_9_2_v2 \
--audio-prompts-dir /home/v-zhijunjia/data/test_vc/test_accent_baseline_paper/promt_3s \
--input-semantic True \
--only-autoregressive True \
--prefix-mode 1 \
--checkpoint1 /home/v-zhijunjia/data/valle-tensorboard-models/pretrain/mode_5_mask_0_15/epoch-29.pt \
--checkpoint2 /home/v-zhijunjia/data/valle-tensorboard-models/vc/only_ar_shared_linear/best-valid-loss-60-epoch.pt \
--top-k ${top_k} \
--top-k-stage2 ${top_k_stage2} \
--shared-linear-stage2 True \
--temperature 1.0 \
--num-quantizers 1 \
...
--is-pretrain True \
--pret-mode 0 \
--outputdir-name "converted_semantic_vc_test_improve/pret_mode5_0_15/epoch29" 
