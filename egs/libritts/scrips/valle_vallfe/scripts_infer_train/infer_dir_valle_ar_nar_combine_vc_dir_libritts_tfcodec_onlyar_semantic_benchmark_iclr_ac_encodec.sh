...
top_k_stage2=10
add_prenet="False"
for checkpoint in $(seq 60 40 60); do  
    ...
    --semantic-sys-dir /home/v-zhijunjia/data/test_accent_baseline_paper/source \
    --input-semantic True \
    --only-autoregressive False \
    --prefix-mode 1 \
    --checkpoint1 /home/v-zhijunjia/data/valle-tensorboard-models/pretrain_finetune/mode_5_mask015_source1spker_600cases_tgt1spker_lr_0005/epoch-6.pt \
    --checkpoint2 /home/v-zhijunjia/data/valle-tensorboard-models/vc/valle/best-train-loss_epoch57.pt \
    --checkpoint-NAR /home/v-zhijunjia/data/valle-tensorboard-models/vc/valle/epoch-79.pt \
    --top-k ${top_k} \
    --top-k-stage2 ${top_k_stage2} \
    --shared-linear-stage2 False \
    --temperature 1.0 \
    --num-quantizers 1 \
    --num-quantizers-stage2 8 \
    --target-mode 2 \
    --accent-remove True \
    --mode 0 \
    --mode-stage2 0 \
    --is-pretrain True \
    --pret-mode 0 \
    --outputdir-name "vctk20cases_ac_encodec_argmax"
done    
