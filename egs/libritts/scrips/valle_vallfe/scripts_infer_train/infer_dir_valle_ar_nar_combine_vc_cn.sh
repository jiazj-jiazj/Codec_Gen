...
do  
  ...
  --input-semantic True \
  --prefix-mode 1 \
  --checkpoint1 /dev_huaying/zhijun/data/valle-tensorboard-models/cn_vc/ar/Name_VALLE_max-duration_50_dtype_float32_base-lr_0.05_world-size_8_train-stage_1_echo_100_start_echo_1_accumulate_grad_steps_4_prefix_mode_1_input_semantic_True_2023_07_12_12_21_16/epoch-16.pt \
  --checkpoint2 /dev_huaying/zhijun/data/valle-tensorboard-models/cn_vc/nar/Name_VALLE_max-duration_50_dtype_float32_base-lr_0.05_world-size_8_train-stage_2_echo_150_start_echo_1_accumulate_grad_steps_4_prefix_mode_1_input_semantic_True_valid_interval_10000_2023_07_12_15_23_53/epoch-11.pt \
  --input-language 1\
  --semantic-layer 9 \
  --top-k ${top_k} --temperature 1.0
done  