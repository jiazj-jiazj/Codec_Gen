...
for epoch in $(seq 15 15 15); do  
    ...
    --semantic-sys-dir /home/v-zhijunjia/demo/iclr_final/vctk_iclr/1demo_need2update_24_2_26 \
    --input-semantic True \
    ...
    --is-pretrain True \
    --pret-mode 0 \
    --outputdir-name "arctic-encodec-ac-de-reverb"
done    
