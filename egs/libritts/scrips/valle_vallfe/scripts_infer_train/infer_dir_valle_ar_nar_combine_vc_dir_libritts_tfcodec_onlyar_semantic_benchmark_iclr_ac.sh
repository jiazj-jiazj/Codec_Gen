...
top_k_stage2=10
add_prenet="False"
for checkpoint in $(seq 20 20 20); do  
    ...
    --semantic-sys-dir /home/v-zhijunjia/zhijundata_small_v2/data_local/data/check_less_bright_voice/source_native \
    --input-semantic True \
    --only-autoregressive True \
    --prefix-mode 1 \
    --checkpoint1 /home/v-zhijunjia/zhijundata_small_v2/data_local/valle-tensorboard-models/pretrain_finetune/mode_5_mask015_source1spker_600cases_tgt1spker_lr_0005/epoch-6.pt \
    --checkpoint2 /home/v-zhijunjia/zhijundata_small_v2/data_local/valle-tensorboard-models/vc/only_ar/epoch-40.pt \
    --top-k ${top_k} \
    ...
    --is-pretrain True \
    --pret-mode 0 \
    --outputdir-name converted_can_del/ac_benchmark_only_pretrain_checkpoint_${basestr}
done    
