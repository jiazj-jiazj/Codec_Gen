...
for epoch in $(seq 1 1 1); do  
    ...
    --prefix-mode 1 \
    --checkpoint1 /home/v-zhijunjia/zhijundata_small_v2/data_local/valle-tensorboard-models/pretrain_finetune/VALLFE_hubert_sem/tune_all_random_tgt_add_native_Libritts_all_native_mask/epoch-${epoch}.pt \
    ...
    --is-pretrain True \
    --pret-mode 0 \
    --outputdir-name converted_can_del/tune_all_random_tgt_add_native_Libritts_all_native_mask_${epoch}_${basestr}
done    
