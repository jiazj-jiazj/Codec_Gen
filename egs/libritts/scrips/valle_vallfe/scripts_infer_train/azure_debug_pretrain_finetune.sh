...
nohup python -u egs/libritts/bin/multiprocess_caller.py --max-duration 200 \
    ...
    --num-quantizers 1 \
    --world-size 1 \
    --manifest-dir /scratch/data/libritts_clean_100_5000_l1l2/tokenized \
    ...
    --is-local True \
    --exp-dir "/home/v-zhijunjia/data/valle-tensorboard-models/pret_finetune_2datasets/5000_5000" \
    --restore True \
    --restore-file-name "pret-infilling-epoch-28.pt" \
    --random-tgt-spk True \
    > egs/libritts/log/lr_002_tgt_mul_sheduler_steps_200_mode2_0_5_libritts5000_l1l2_${basestr}.txt 2>&1 &
