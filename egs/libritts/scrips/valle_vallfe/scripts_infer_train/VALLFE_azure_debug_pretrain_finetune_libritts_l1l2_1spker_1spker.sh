...
python egs/libritts/bin/multiprocess_caller.py --max-duration 200 \
    ...
    --is-local True \
    --exp-dir "/home/v-zhijunjia/zhijundata_small_v2/data_local/valle-tensorboard-models/pretrain_finetune/VALLFE_hubert_sem/mode5_15_tune_all" \
    --restore True \
    --restore-file-name "pret-epoch-31.pt" \
