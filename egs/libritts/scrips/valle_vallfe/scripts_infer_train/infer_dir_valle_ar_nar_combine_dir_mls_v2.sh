...
for top_k in $(seq 10 10 140); do
  ...
  CUDA_VISIBLE_DEVICES=0 python egs/libritts/bin/combine_ar_nar_vc_dir_onlyar.py \
    ...
    --nums ${num_runs} \
    --task-id 1 \
    --checkpoint1 /home/v-zhijunjia/zhijundata_small_v2/data/LibriTTS/lhotse_vc/output_vc/tts_VALLE_ybos_False_m-dur_80_b-lr_0.05_eo_70_s_eo_1_p_md_1_i_seman_False_o_ar_True_n_qua_16_s_seps_50000_s_epoc_4_a_g_s_2_s_depup_False_s_rmv_False_dim_1024_n_16_n_d_lrs_12_2023_12_08_13_47_09/epoch-45.pt \
    ...
    --outputdir-name converted_tts/tts_results_${basestr}_topk_${top_k} \
