...
--prefix-mode 1 \
--checkpoint1 /home/v-zhijunjia/zhijundata_small_v2/data/LibriTTS/lhotse_vc/output_vc/vc_Name_VALLE_m-dur_50_dty_float32_b-lr_0.05_ech_70_s_echo_1_n_quan_16_s_stps_5000_s_epo_4_a_g_steps_4_s_depup_True_2023_11_08_13_00_14/epoch-70.pt \
--top-k ${top_k} \
...
--mode 0 \
--mode-stage2 0 \
--outputdir-name converted_test_can_del/vc_source_native_hubert_depup_v2_top_${top_k}_topp_${top_p}_${basestr} 
