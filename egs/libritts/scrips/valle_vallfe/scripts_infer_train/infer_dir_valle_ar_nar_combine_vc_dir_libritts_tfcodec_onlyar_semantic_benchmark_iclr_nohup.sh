...
--semantic-sys-dir /home/v-zhijunjia/data/benchmark_librispeech_10speakers/source \
--audio-prompts-dir /home/v-zhijunjia/data/benchmark_librispeech_10speakers/prompt \
--input-semantic True \
...
--is-pretrain True \
--pret-mode 0 \
--outputdir-name "converted_pretrain_mode5_015_epoch29" \
> egs/libritts/log/pret_mode_5_mask_0_15_vc_${basestr}.txt 2>&1 &
