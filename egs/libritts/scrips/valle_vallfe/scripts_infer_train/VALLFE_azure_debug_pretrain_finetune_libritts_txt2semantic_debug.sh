...
python egs/libritts/bin/multiprocess_caller.py --max-duration 5 \
    --nproc-per-node 1 \
    ...
    --num-quantizers 1 \
    --world-size 1 \
    --manifest-dir /home/v-zhijunjia/zhijundata_small_v2/data/LibriTTS/lhotse_vc/vc_tokenized_16k_tfcodec_16codes \
    ...
    --is-local True \
    --exp-dir "/home/v-zhijunjia/zhijundata_small_v2/data_local/valle-tensorboard-models/pretrain_finetune/VALLFE_hubert_sem/tune_txt2semantic_debug" \
    --restore False \
    ...
    --pret-lam 3 \
    --pret-token 500 \
    --train-dir-name "small_cuts_train.jsonl.gz" \
    --val-dir-name "small_cuts_dev.jsonl.gz"
