...
--semantic-sys-dir /home/v-zhijunjia/zhijundata_small/data_local/ac_demo/emotion_sour \
--audio-prompts-dir /home/v-zhijunjia/zhijundata_small/data_local/ac_demo/emotion_reff \
--input-semantic True \
--only-autoregressive True \
--prefix-mode 1 \
--checkpoint1 /home/v-zhijunjia/zhijundata_small/data/LibriTTS/lhotse_vc/output_vc/sem_tp_1_Name_VALLE_max-duration_50_dtype_float32_base-lr_0.05_train-stage_1_echo_50_start_echo_1_prefix_mode_1_input_semantic_True_only_ar_True_num_quantizers_16_sheduler_steps_5000_sheduler_epochs_4_accumulate_grad_steps_4_2023_10_25_12_04_29/epoch-50.pt \
--top-k ${top_k} \
...
--mode 0 \
--mode-stage2 0 \
--outputdir-name converted_emotion_vc/v2_top_${top_k}${basestr} 
