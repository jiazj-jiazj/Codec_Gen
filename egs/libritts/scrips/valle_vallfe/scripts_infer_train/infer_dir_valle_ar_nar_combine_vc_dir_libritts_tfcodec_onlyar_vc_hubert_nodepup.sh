...
--semantic-sys-dir /home/v-zhijunjia/zhijundata_small_v2/data_local/data/check_less_bright_voice/source \
--input-semantic True \
...
--mode 0 \
--mode-stage2 0 \
--outputdir-name converted_test_can_del/check_bright_voice
# /mnt/users/jiazhijun/data/valle-tensorboard-models/accents/ar_accents_restore/restore_from_vc_libritts.pt
# --audio-prompts-dir /home/v-zhijunjia/demo/iclr_final/more_accents_dereverb/korea \
