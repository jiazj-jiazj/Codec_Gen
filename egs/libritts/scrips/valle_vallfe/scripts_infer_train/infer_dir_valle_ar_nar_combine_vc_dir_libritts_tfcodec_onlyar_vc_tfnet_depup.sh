...
--semantic-sys-dir /home/v-zhijunjia/data/test_vc/test_real_cases/source \
--audio-prompts-dir /home/v-zhijunjia/data/test_vc/test_real_cases/3s_prompt \
--input-semantic True \
--only-autoregressive True \
--prefix-mode 1 \
--checkpoint1 /home/v-zhijunjia/zhijundata_small/data/LibriTTS/lhotse_vc/output_vc/vc_Name_VALLE_m-dur_50_dty_float32_b-lr_0.05_ech_70_s_echo_1_n_quan_16_s_stps_5000_s_epo_4_a_g_steps_4_s_depup_True_2023_11_08_13_00_14/epoch-18.pt \
--top-k ${top_k} \
...
--mode 0 \
--mode-stage2 0 \
--outputdir-name converted_test_can_del/tfnet_vc_v2_top_${top_k}${basestr} 
