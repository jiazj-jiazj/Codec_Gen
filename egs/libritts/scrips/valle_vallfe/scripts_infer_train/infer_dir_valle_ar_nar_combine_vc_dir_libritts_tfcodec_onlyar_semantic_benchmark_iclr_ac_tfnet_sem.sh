...
for checkpoint in $(seq 60 40 60); do  
    ...
    --is-pretrain True \
    --pret-mode 0 \
    --outputdir-name ac_100cases_benchmark/ac_benchmark_cases_epoch20_${top_k}_top_stage2_${top_k_stage2}_${basestr}
done    
