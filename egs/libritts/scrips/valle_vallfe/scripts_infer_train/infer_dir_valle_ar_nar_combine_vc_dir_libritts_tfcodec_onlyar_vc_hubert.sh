...
# --semantic-sys-dir /home/v-zhijunjia/zhijundata_small_v2/data/l1_l2_arctic/data/Accents/arctic_more_native/cmu_us_aew_arctic/wav \
# --input-semantic True \
...
# --mode 0 \
# --mode-stage2 0 \
# --outputdir-name converted_test_can_del/test_ac
...
--nums ${num_runs} \
--semantic-tokens /scratch/data/Libritts/tokenized_tfnet_semantic_token/unique_semantic_tokens.k2symbols \
--semantic-sys-dir /home/v-zhijunjia/data/data_update/expore_gap_bettwen_tts_vc/vc_min/source \
--audio-prompts-dir /home/v-zhijunjia/data/data_update/expore_gap_bettwen_tts_vc/vc_min/prompt \
--input-semantic True \
--only-autoregressive True \
--prefix-mode 1 \
--checkpoint1 /home/v-zhijunjia/data/valle-tensorboard-models/vc/only_ar/epoch-40.pt \
...
--num-quantizers 16 \
--input-codec 1 \
--outputdir-name "converted_vc_onlyar_v0_ar" \
...
# --nums-stage2 ${num_runs_stage2} \
# --semantic-tokens /scratch/data/Libritts/tokenized_tfnet_semantic_token/unique_semantic_tokens.k2symbols \
# --semantic-sys-dir /home/v-zhijunjia/data/data_update/benchmark_librispeech_10speakers/4s_source_cut \
# --audio-prompts-dir /home/v-zhijunjia/data/data_update/benchmark_librispeech_10speakers/3s_search_concact_prompt_files_3_3 \
# --input-semantic True \
# --only-autoregressive True \
# --prefix-mode 1 \
# --checkpoint1 /home/v-zhijunjia/data/valle-tensorboard-models/vc/only_ar/epoch-40.pt \
...
# --mode 0 \
# --mode-stage2 0 \
# --outputdir-name converted_test_can_del/test1