...
top_k_stage2=70
add_prenet="False"
for top_k_stage2 in $(seq 1 1 10); do  
    ...
    --is-pretrain True \
    --pret-mode 0 \
    --outputdir-name converted_can_del/no-prompt-tts-2stages_topk_stage1_${top_k}_topk_stage2_${top_k_stage2}_${basestr} > /home/v-zhijunjia/CodecGen/egs/libritts/log/tts-2stages-soundstorm-group-ar_topk_stage1_${top_k}_${basestr}.txt 2>&1 &
done    
