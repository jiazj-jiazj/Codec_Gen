...
for steps in 16 32; do  
    ...
    --semantic-sys-dir /home/v-zhijunjia/data/data_update/expore_gap_bettwen_tts_vc/vc/source \
    --audio-prompts-dir /home/v-zhijunjia/data/data_update/expore_gap_bettwen_tts_vc/vc/prompt \
    --input-semantic True \
    ...
    --outputdir-name converted_test_can_del/soundstorm_test_steps_${steps}_topk_${top_k}_group_ar_${basestr}
...
#     --top-k ${top_k} \
#     --soundstorm-steps ${steps} \
#     --outputdir-name converted_test_can_del/soundstorm_test_steps_${steps}_topk_${top_k}_group_ar_test 
#     # > /home/v-zhijunjia/CodecGen/egs/libritts/log/soundstorm_gr_ar_test_steps_${steps}_topk_${top_k}_${basestr}.txt 2>&1 &
#     # --outputdir-name converted_test_can_del/soundstorm_test_steps_${steps}_topk_${top_k} > /home/v-zhijunjia/CodecGen/egs/libritts/log/soundstorm_test_steps_${steps}_topk_${top_k}_${basestr}.txt 2>&1 &
# done
