...
python egs/indian_accent_english/bin_commit/multiprocess_caller.py --nproc-per-node 1 --nnodes 1 --max-duration 80 \
    ...
    --num-quantizers 1 \
    --world-size 1 \
    --train-dir-name filter_Indic_TTScuts_all_0.jsonl.gz \
    --manifest-dir /home/v-zhijunjia/zhijundata_small_v2/data/IndicTTS/lhotse_data/splited_lhotse_data_v3/splited_lhotse_data \
    ...
    --output-dir /home/v-zhijunjia/zhijundata_small_v2/data/IndicTTS/generated_semantics \
