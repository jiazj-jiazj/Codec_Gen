...
def get_scheduler(params, optimizer):
    if params.scheduler_name.lower() == "eden":
        scheduler = Eden(optimizer, params.sheduler_steps, params.sheduler_epochs, warmup_batches=params.warmup_steps)
        print(f"sheduler_steps:{params.sheduler_steps}, sheduler_epochs:{params.sheduler_epochs}")
