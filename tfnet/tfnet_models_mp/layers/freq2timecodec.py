...
class Freq2TimeCodec(nn.Module):
    def __init__(self, frm_size, shift, win_len, hop_len, n_fft, config=None, power=None, center=True):
        ...
        self.istft = ISTFT(filter_length=win_len, hop_length=hop_len, window='hann', center=center)
